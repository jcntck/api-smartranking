import { Body, Controller, Get, Post, UsePipes, ValidationPipe, Query, Put, Param, Delete } from '@nestjs/common';
...
export class DesafiosController {
    ...
    @Get()
    async consultarDesafios(@Query('idJogador') idJogador: string): Promise<Array<Desafio>> {
        return idJogador ? await this.desafioService.consultarDesafiosDeUmJogador(idJogador)
    ...
    async atribuirPartidaDesafio(
        ...
        await this.desafioService.atribuirPartidaDesafio(_id, atribuirPartidaDesafioDto);
    }
